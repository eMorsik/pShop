...
namespace pShop {
	...
	/// <summary>
	/// Сводка для ModeSeller
	/// </summary>
	public ref class ModeSeller : public System::Windows::Forms::Form
	{
	public: static bool smod = false;
	public:
		ModeSeller(void)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ModeSeller::typeid));
			...
			// pbSeller
			// 
			this->pbSeller->ImageLocation = L"C:\\Users\\MorDg\\source\\repos\\pShop\\images\\seller.png";
			...
			this->btnExit->Click += gcnew System::EventHandler(this, &ModeSeller::btnExit_Click);
			// 
			// btnLogin
			// 
			...
			this->btnLogin->Click += gcnew System::EventHandler(this, &ModeSeller::btnLogin_Click);
			// 
			// lblAdmOn
			// 
			...
			this->tbPass->TextChanged += gcnew System::EventHandler(this, &ModeSeller::tbPass_TextChanged);
			// 
			// tbLogin
			// 
			...
			this->tbLogin->TextChanged += gcnew System::EventHandler(this, &ModeSeller::tbLogin_TextChanged);
			// 
			// ModeSeller
			// 
			...
			this->Name = L"ModeSeller";
			this->Text = L"ModeSeller";
			this->Load += gcnew System::EventHandler(this, &ModeSeller::ModeSeller_Load);
...
#pragma endregion
	private: System::Void ModeSeller_Load(System::Object^ sender, System::EventArgs^ e);
